...
from power_narrator.ui.audio_identity import EMBEDDED_AUDIO_FILENAME
from power_narrator.ui.qml_modules.PowerNarrator.models import (
    ProvidersModel,
    VoicesModel,
)
from power_narrator.ui.qml_modules.PowerNarrator.workers import (
    AudioGenerateWorker,
    VoiceFetchWorker,
)
from power_narrator.ui.tts.google import GoogleTTSProvider
from power_narrator.ui.tts.provider import ProviderInfo, TTSProvider, Voice
...
class TTSManager(QObject):
    ...
    def _get_output_file_path(self) -> str:
        ...
        temp_dir = Path(temp_location) / "power-narrator"
